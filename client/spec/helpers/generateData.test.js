...
describe('generateData', () => {
  ...
  it('Should reformat all recAreas data appropriately', () => {
    ...
    },
    {
      ...
      EntityID: 59,
      RecAreaLatitude: 30.62,
      RecAreaLongitude: -96.34,
      RecAreaName: 'WestWorld2',
      RecAreaPhone: '760-557-9876',
      RecAreaDescription: 'WestWorld2 is located in north Scottsdale at the base of the McDowell Mountains.',
      RecAreaEmail: 'westworld2@gmail.com'
    }];
    ...
    expect(generateData(entities)[1].recArea).to.be(true);
    expect(generateData(entities)[1].entityID).to.be(59);
    expect(generateData(entities)[1].facility).to.be(false);
  });
